...
@section('content')
    <div class="mx-5"> 
        ...
        <div class="text-center text-gray-500">
            <div class="m-auto">
                <h3 class="mt-6 max-w-2xl m-auto">Imagine, download, design, and share your dream truss design with your local truss manufacturer to make the design process stupid simple</h1>
            </div>
        </div>
